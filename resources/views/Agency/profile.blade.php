...
<div class="py-12">
    ...
    @endif
    <!-- Profile Update Form -->
    <form action="{{ route('Agency.updateProfile', ['user_id' => Auth::id()]) }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="mb-4">
            <label>Name</label>
        ...
        <div class="mb-4">
            <label>Phone</label>
            <input type="text" name="phone" value="{{ old('phone',$user->agency->phone) }}"
...
@endif
    ...
    <form action="{{ route('Agency.changePassword', ['user_id' => Auth::id()]) }}" method="POST">
        @csrf
